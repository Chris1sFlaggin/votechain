...
-   Sito: **[https://chris1sflaggin.it/votechain](https://chris1sflaggin.it/votechain)**
-   Codice: **[https://github.com/chris1sflaggin/votechain](https://github.com/chris1sflaggin/votechain)**
...
Per usarla: **MetaMask** deve essere installato con un wallet che abilitato ad usare Sepolia. Connetti il wallet: il wallet che ha fatto il deploy (o il secondo gov cablato) vede i **pannelli governo**; ognialtro wallet è un **cittadino** che vota nei referendum e firma le proposte.
...
L’**account 0** (lo stesso che esegue lo script) è il governo; gli altri account sono elettori.
